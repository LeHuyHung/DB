...
CUDA_VISIBLE_DEVICES=0 python api.py experiments/seg_detector/totaltext_resnet50_deform_thre.yaml --image_path /home/asilla/10_dataset/hunglh/text_detection/data/debug --resume /home/asilla/10_dataset/hunglh/text_detection/DB/outputs/workspace/DB/SegDetectorModel-seg_detector/deformable_resnet50/L1BalanceCELoss/model/model_epoch_2927_minibatch_684000 --polygon --box_thresh 0.002 --port=6007 --visualize