...
CUDA_VISIBLE_DEVICES=2 python demo.py experiments/seg_detector/totaltext_resnet50_deform_thre.yaml --image_path /home/asilla/10_dataset/hunglh/text_detection/data/east_detect/final_testset_allRect/images --resume /home/asilla/10_dataset/hunglh/text_detection/DB_notskip_bottom_line/DB/workspace/SegDetectorModel-seg_detector/deformable_resnet50/L1BalanceCELoss/model/model_epoch_1513_minibatch_1008000 --polygon --box_thresh 0.02
